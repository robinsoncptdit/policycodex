...
|---|---|---|---|---|
| OQ-05 | LA contact's role in README | Chuck | 2026-05-15 (Week 2) | **open.** LA contact is **David Schmitt, IT Director, Archdiocese of Los Angeles** (Chuck confirmed name on 2026-05-15; full contact in Scarlet's auto-memory `reference_la_archdiocese_contact.md`, not committed to public repo). Next action (Chuck): message David to confirm whether he's named as "design reviewer," "design partner," or another role; loop the language back. README update is a small follow-up commit once decided. |
