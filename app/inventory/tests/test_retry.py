...
def _fake_config(tmp_path):
    return SimpleNamespace(working_dir=tmp_path, branch="main")
...
def test_retry_item_resets_status(client, editor, tmp_path):
    ...
    with (
        patch("app.inventory.views.start_run") as start,
        patch("app.inventory.views.load_working_copy_config", return_value=_fake_config(tmp_path)),
