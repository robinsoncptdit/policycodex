...
| APP-22 | Extract the duplicated `_resolve_repo` subprocess invocation across `clone`, `branch`, `commit`, `push`, and `pull` in `app/git_provider/github_provider.py` into one shared helper. Tiny refactor, no behavior change, net test count unchanged. Flagged by three separate Wave-3 reviewers (APP-17 / APP-18 / APP-19 quality). Cross-cutting App-lane hygiene; added to the board 2026-05-24 per the Week-4 sprint plan. | S | 4 | APP-04, APP-17 |
